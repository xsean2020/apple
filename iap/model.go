...
type (
	...
	Receipt struct {
		...
		AppItemID                  Number  `json:"app_item_id"`
		BundleID                   string  `json:"bundle_id"`
		ApplicationVersion         string  `json:"application_version"`
		DownloadID                 int64   `json:"download_id"`
		VersionExternalIdentifier  Number  `json:"version_external_identifier"`
	...
	ReceiptForIOS6 struct {
		...
		ProductID            string `json:"product_id"`
		PurchaseDate
		OriginalTransactionID Number `json:"original_transaction_id"`
		OriginalPurchaseDate
		Quantity                  string `json:"quantity"`
		TransactionID             string `json:"transaction_id"`
		UniqueIdentifier          string `json:"unique_identifier"`
		UniqueVendorIdentifier    string `json:"unique_vendor_identifier"`
		VersionExternalIdentifier Number `json:"version_external_identifier,omitempty"`
